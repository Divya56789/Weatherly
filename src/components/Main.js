...
function Main(props) {
  ...
  const Geolocation = () => {
    ...
    if (
      ...
      axios
        .get(`https://api.openweathermap.org/data/2.5/weather?appid=${apikey}`, {
          params: {
            units: unit,
            lat: coords.latitude,
    ...
    <div className="container">
      <nav>
        ...
        <div className="cel-frah">
          <button
            onClick={() => changeToCelFarh("metric")}
            style={{
              color: unit === "metric" ? "white" : "black",
              backgroundColor: unit === "metric" ? "black" : "white",
            }}
          >
            <span>&#186;C</span>
          </button>
          <button
            onClick={() => changeToCelFarh("imperial")}
            style={{
              color: unit === "imperial" ? "white" : "black",
              backgroundColor: unit === "imperial" ? "black" : "white",
            }}
          >
            <span>&#186;F</span>
          </button>
      ...
      <section>
        <div className="sidebar">
          ...
          <div className="currentDetail2">
            <div className="main">
              {result.icon === "01d" ? (
                <img src={sun} alt="clear sky" width={26} height={26} />
              ) : result.icon === "01n" ? (
                <img src={moon} alt="clear sky" width={26} height={26} />
              ) : result.icon === "02d" ? (
                <img
                ...
                <img src={clouds} alt="broken clouds" width={26} height={26} />
              ) : result.icon === "09d" || result.icon === "09n" ? (
                ...
                <img src={snow} alt="snow" width={26} height={26} />
              ) : result.icon === "50d" || result.icon === "50n" ? (
                <img src={fog} alt="fog" width={26} height={26} />
              ) : (
          ...
          <div className="image">
            ...
            <h1 className="location-image">
              {result.cityName ? result.cityName : "Location"},
              {result.country ? result.country : "Cn"}
            </h1>
          </div>
      ...
      <div className="daydetail">
        <div className="clouds">
          <h3 className="cloud-h3">Clouds</h3>
          <img src={clouds_1} alt="cloud" width={50} height={50} />
          <h3>{result.clouds ? result.clouds : 0}</h3>
        </div>

        <div className="max-temp">
          <h3 className="max-h3">Max_temp</h3>
        ...
        <div className="min-temp">
          <h3 className="min-h3">Min_temp</h3>
          <img src={temp} alt="temp" width={40} height={40} />
          {unit === "metric" ? (
      ...
      <div className="content2">
        ...
        {unit === "metric" ? (
          ...
          <h1 className="c2-h1">
            {result.windSpeed}{" "}
            <span style={{ fontSize: "medium" }}>miles/hr</span>
          </h1>
        )}
      ...
      <div className="content4">
        ...
        <div className="humidity">
          <p>
            {result.humidity >= 30 || result.humidity <= 60 ? "Normal" : ""}
          </p>
          <p style={{ fontSize: "40px" }}>
            {result.humidity >= 30 || result.humidity <= 60 ? "👍" : "👎"}
          </p>
        </div>
      </div>
        ...
        <div className="visibility">
          <p>
            {result.visibility === 10
              ? "Maximum"
              : result.visibility >= 3 || result.visibility <= 6
              ? "Average"
              : "Good"}
          </p>
          <p style={{ fontSize: "40px" }}>
